...
import { testExports } from "@/web/price-check/filters/create-stat-filters";
...
describe("item mod count tests", () => {
  it.each([
    ...
    const res = testExports.itemMaxModifiersBySlot(item, []);
  ...
  it.each([
    ...
    (
      ...
      const res = testExports.itemMaxModifiersBySlot(
        item,
